...
- ⬜ **Còn mở 5 mục** — chỉ **G8b** (bảng ánh xạ mã API `F#####` ↔ tên điểm đo) **chặn nghiệm thu MOD-03**; không mục nào chặn Phase 0/1. Còn lại: **G3-a** lượng mưa (chờ endpoint / nhập tay / bỏ) · **G5** mã số hệ thống văn bản riêng hay chung (+ xin SSO) · **G6** mẫu 2C-BNV · **G8** danh sách điểm đo + tọa độ · **G9-a** bộ mức ngưỡng · **G10** duyệt format báo cáo.
