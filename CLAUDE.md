...
| 5/9 | **cổng quét CVE soi 110 jar trong khi runtime có 121** — bảy gói chưa từng được quét lần nào, gồm `spring-context`/`spring-beans` là nơi `DataBinder` nằm. Mọi con số CVE trong sổ là **cận dưới** | T11.83 |
| 5/9 | **chuông CVE mang đúng MỘT bit** — 6 bình luận tự động cùng **732 byte**, cùng vân tay, trong khi tập CVE đi từ 12/7 lên 15/8 kèm gói mới dính. *Đỏ-như-cũ* và *đỏ-và-tệ-hơn* in ra cùng một câu | T11.84 |
