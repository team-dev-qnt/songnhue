...
| `T11.54` | Cổng 5201 mở trên VPS-2 | VPS-2: `sudo ss -tlnp \| grep ':5201'` → xác định tiến trình → `sudo systemctl disable --now <dịch vụ>` → từ ngoài `nc -z -w3 27.71.27.75 5201; echo $?` phải ≠ 0. ⛔ `ufw` — VPS-2 ⛔ cài (sửa 19/09) |
