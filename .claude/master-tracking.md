...
- [ ] T25.24: **Thư viện ảnh công trình chưa mở ra cổng** — vế còn lại của CR-20 và của nợ T11.30 | Note: `HomeMediaGallery.photos` nay có nơi truyền nhưng chưa có nguồn. Ảnh hiện trạng đang nằm trong hồ sơ từng công trình (`ops:document:*`), mở ra công khai là quyết định về **phạm vi công bố** — phải kèm bài kiểm cố tình hỏi ảnh của Xí nghiệp khác
