...
5. ⚠ **Cảnh báo lặp lại hàng trăm lần mỗi lượt là một hỏng hóc, không phải nền nhiễu.** Sonatype OSS Index đổ **130 cảnh báo mỗi lượt quét** suốt 4 lượt liền — tức nó lỗi ở gần như mọi artifact và **chưa từng đóng góp dữ liệu nào**. Không ai đọc, vì nó chỉ là `[WARNING]`. Tới lượt thứ tư Sonatype chặn truy cập ẩn danh (401) thì DC nâng lên `AnalysisException` và **giết cả build đúng lúc cổng CVE vừa sạch**. Nguồn dữ liệu hỏng thì tắt đích danh và ghi lại, đừng để nó nằm đó kêu.
