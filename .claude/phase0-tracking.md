...
| 48 | **Xác nhận lượt quét OWASP sau khi nâng cấp thật sự XANH** — mới chỉ chứng minh gián tiếp (263 test + phiên bản đã giải đúng trong `dependency:tree`); chưa chạy lại phép quét vì CSDL NVD dựng mất 26' và khoá NVD chỉ có trên CI | WS-10/T10.6 | Lượt `security-scan` kế tiếp | ⬜ Chờ |
