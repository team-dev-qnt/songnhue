...
| **Phase 2** — C2 (`hydro`) | điểm đo, adapter, polling, rate-limit, lưu trữ, alert engine | ✅ **XONG phần mã 08/9/2026** | DoD **19/22**. Ba mục còn lại ⛔ **không phải mã** — `DOD2.9` cần một lượt bắn chuông thật trên VPS-2 (VM-3 đã gộp vào VPS-2 — T61.16) · `DOD2.21` cần **7 ngày lịch** · `DOD2.22` cần load test ⇒ chúng **chạy song song** với Phase 3, ⛔ không chặn |
