  ...
  if (tinhTrang.loiCauHinh) {
    return (
      <Alert
        ...
        title="Quy tắc phân loại đang HỎNG — bộ phân loại đã tắt"
        description={
          <>
  ...
  if (!tinhTrang.dangKiem) {
    return (
      <Alert
        ...
        showIcon
        style={{ marginBottom: 16 }}
        title="Chưa cấu hình quy tắc phân loại — bảng dưới sẽ RỖNG VĨNH VIỄN"
        description={
          <>
  ...
  if (soDong === 0) {
    return (
      <Alert
        ...
        showIcon
        style={{ marginBottom: 16 }}
        title="Bộ phân loại đang chạy và không có số đo nào đáng ngờ"
      />
    );
  }
  return (
    <Alert
      ...
      showIcon
      style={{ marginBottom: 16 }}
      title={`${soDong} số đo đang chờ duyệt trên trang này`}
      description={
        <>
