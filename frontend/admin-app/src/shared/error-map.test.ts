...
describe('error-map đồng bộ với danh mục của backend', () => {
  ...
  it('có đủ 79 mã: 62 đến hết WS-15, + 9 mã OPS của WS-17, + OPS-2017 (WS-18), + OPS-2018/2019 (nghiệm thu lại WS-19), + CMS-2015 (logo Liên kết cổng TTĐT, 29/08), + SYS-0011 (tệp vượt trần multipart, 30/08), + HYD-1002/2005/2006 (danh mục điểm đo, WS-28), + HYD-2007 (ô đã có số đo, WS-32), + OPS-2020 (hiệu lực ở tương lai, V3)', () => {
